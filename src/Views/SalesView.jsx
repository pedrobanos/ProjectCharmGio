...
//                         {filteredSales.map((s) => {
//                             const isBlacklisted = blacklist.has(s.id);
//                             return (
...
//                                     </td>
//                                     <td className="px-2 py-2 truncate">{s.cliente}</td>
...
//       // 🔹 Filtrar ventas de Carol por nombre (agrupando variantes)
...
//   // 🔹 Filtros por cliente (se agrupan nombres que incluyan "gio" o "carol")
//   const filteredSales = sales.filter((s) => {
